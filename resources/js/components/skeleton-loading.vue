...
<div class="flex flex-wrap -m-4">
    <div class="p-3 md:w-1/3">
        <div class="border border-gray-300 shadow-lg rounded-md max-w-sm w-full mx-auto bg-white">
            <div class="lg:h-48 bg-gray-400 md:h-36 w-full object-cover object-center"></div>
            <div class="animate-pulse flex space-x-4 pl-4 pr-4 pt-4">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center flex-wrap">
                    ...
                    <span class="bg-indigo-300 w-1/3 mt-2 h-4 animate-pulse mr-3 px-2 inline-flex items-center ml-auto leading-none text-sm pr-5 py-1"></span>
                </div>
            </div>
        </div>
    </div>
